...
export default function ExperimentModal({ sourceType, innovationId, arxivIds, open, onClose }: Props) {
  ...
  }, [open, sourceType, innovationId, arxivIds])
  ...
  const handleGenerate = async () => {
    ...
    try {
      const rec = await createExperiment({
        ...
        innovation_id: sourceType === 'innovation' ? innovationId ?? null : null,
        arxiv_ids: arxivIds,
        count,
        language,
      })
