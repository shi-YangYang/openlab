...
@app.get("/api/papers/{arxiv_id:path}/translation/pdf")
...
@app.get("/api/papers/{arxiv_id:path}/translation")
...
@app.post("/api/papers/{arxiv_id:path}/translate")
async def start_translation(
    ...
    async def job() -> None:
        try:
            ...
            translation_progress_message[arxiv_id] = redact(str(exc), cfg.get("api_key", ""))
...
@app.get("/api/papers/{arxiv_id:path}/translate/progress")
...
@app.delete("/api/papers/{arxiv_id:path}/translation")
